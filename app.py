...
def get_school_data(lat, lon):
    # Placeholder for real school API call, return dummy list
    return [
        {'name': "Example School A", 'rating': 7, 'gradeRange': "K-8", 'type': "Public"},
        {'name': "Example School B", 'rating': 9, 'gradeRange': "9-12", 'type': "Private"},
    ]
